        ...
        try {
            if ($price > 0) {
                ...
                foreach ($installmentPlans as $planKey => $planValue) {
                    ...
                    if ($installmentNumber < $maxInstallments || $installmentNumber == $maxInstallments ) {

                        if ($installmentNumber < $installmentsWithoutInterest) {

                            $value = $price / $installmentNumber;

                            $total = $price;

                            $planValue['interest_free'] = true;
