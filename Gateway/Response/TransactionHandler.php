...
class TransactionHandler implements HandlerInterface
{
    ...
    {
        $this->checkoutSession->unsetData('pagseguropayment_installments');
        ...
        if (isset($transaction['id'])) {
            ...
            if (isset($transaction['amount']['value'])) {
                ...
                $ordered_amount =  $transaction['amount']['value'];

            } else {

                if (isset($transaction['qr_codes']['amount']['value'])) {

                    $ordered_amount = $transaction['qr_codes']['amount']['value'];

                }

            }

            $payment->setAdditionalInformation('ordered_amount',$ordered_amount);
