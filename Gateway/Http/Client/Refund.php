...
class Refund implements ClientInterface
{
    ...
    public function placeRequest(TransferInterface $transferObject)
    {
        ...
        if (
            ...
            && !in_array($transaction['response']['status'], $this->api->deniedStatuses())
            && $transaction['response']['status'] != Api::STATUS_WAITING
        ) {
            $transaction = $this->api->transaction()->cancelCharge(
                $transactionId,
