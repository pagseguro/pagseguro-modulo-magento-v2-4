...
namespace PagSeguro\Payment\Model\TwoCreditCard\Ui;
...
{
    const CODE = 'pagseguropayment_two_cc';
                ...
                'ccform' => [
                    ...
                    'urls' => [
                        $methodCode => [
                            ...
                            'retrieve_installments' => $this->urlBuilder->getUrl('pagseguropayment/installments/twoCards'),
